...
- **Line snapping** — the warp alone leaves vehicles beside the artwork, so
  ...
  - Where not even a pin can be placed, the corridor itself is drawn by hand
    ...
    failures at once to come to that, and nine cases have them: Metro 761's
    ...
    of Carson, below; Torrance 5's south end, where the "5" printed on the drawn
    PCH is 43 px from the warp's *Arlington* leg and 65 from the PCH leg it is
    printed on, so the fit pulls a point 130 px into the route down onto it and
    leaves the terminus to snap onto the grey the sheet draws the streets
    themselves in; and Montebello 10 down Atlantic, where the sheet
